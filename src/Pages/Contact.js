          ...
          <div className="py-6 md:py-0 md:px-6 mt-16">
            ...
            <div className="space-y-4">
              ...
              <p className="flex items-center">
                ...
                <span>omarfaruk7022@gmail.com</span>
              </p>
            </div>
          </div>
          <form
          ...
          >
            <label className="block">
              ...
              <input
                ...
                className="block w-full h-10 rounded-md shadow-sm focus:ring focus:ring-opacity-75 border focus:ring-violet-400 bg-base-100"
              />
            </label>
            <label className="block">
            ...
            <label className="block">
              ...
              <textarea
                ...
                className="block w-full rounded-md focus:ring focus:ring-opacity-75 border focus:ring-violet-400 bg-base-100"
                spellcheck="false"
              ></textarea>
            </label>
            <button
